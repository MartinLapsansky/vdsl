...
//
//    public EscapeRoomService(MqttServiceInterface mqttService) {
//        this.mqttService = mqttService;
//    }
//
//    public void startGame() throws MqttException, InterruptedException {
//        EscapeRoomBuild escapeRoom = new EscapeRoomBuild.EscapeRoomBuilder(mqttService) // Pass mqttService here
